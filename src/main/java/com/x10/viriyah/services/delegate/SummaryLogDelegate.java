...
@Slf4j
@Component
public class SummaryLogDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        String stepName = "send-error-email";
        ...
        log.info("Start - Notify Admin -- Workflow error.");
        ...
        if ("Y".equals(sendMailFailedFlag)) {
            ...
            String mailSubject = "Error Camunda (For Mule) " + execution.getVariable("policyNumber");
